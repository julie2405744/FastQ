...
function startCountdown(slotDate, slotTime){
    ...
    document.getElementById('step-lobby').className='step done';
    document.getElementById('step-session').className='step ';

    var display=document.getElementById('countdown');
    var labelE1=document.getElementById('timer-label');
    ...
    labelE.textContent='Until'+ formatDate(slotDate)+ 'at'+formatTime(slotTime);
    ...
    function tick(){
        ...
        var totalSecs = Math.floor(diddMs/1000);
        var days=Math.floor(totalSecs/86400);
        var hrs=Math.floor((totalSecs/86400)/3600);
        var mins=Math.floor((totalSecs/86400)/60);
